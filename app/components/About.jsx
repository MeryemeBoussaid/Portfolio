    ...
    >
      ...
      className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        className='flex-1'>
            ...
            >I am a computer engineering student at ENSAT, seeking a PFA internship from July 2025. Skilled in backend development and application security , I have implemented secure authentication and DevSecOps principles. Motivated, creative, and a team player, I am eager to contribute to impactful projects while expanding my expertise.</p>
            <motion.ul 
            initial={{opacity: 0}}
            whileInView={{opacity: 1}}

  ...
  return (
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden'>
      ...
      flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
        <a href="#top">
          <Image 
            src={isDarkMode ? assets.logo_dark: assets.logo} alt=''
            className='w-40 lg:w-48 cursor-pointer mr-14'
        ...
        <ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 ${isScroll ? "" : "bg-white shadow-sm bg-opacity-50 dark: border dark:border-white/50 dark:bg-transparent"} `}>
          ...
          <li><a className='fony-Ovo' href="#work">My work </a></li>
          <li><a className='fony-Ovo' href="#contact">Contact me </a></li>
        </ul>
        ...
        <ul ref={sideMenuRef} className='flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 dark:bg-darkHover dark:text-white'>
          ...
          <li><a className='fony-Ovo' onClick={closeMenu} href="#home">Home</a></li>
          <li><a className='fony-Ovo' onClick={closeMenu} href="#about">About me </a></li>
          <li><a className='fony-Ovo' onClick={closeMenu} href="#services">Services </a></li>
          <li><a className='fony-Ovo' onClick={closeMenu} href="#work">My work </a></li>
          <li><a className='fony-Ovo' onClick={closeMenu} href="#contact">Contact me </a></li>
        </ul>
      </nav>
    </>
  );
